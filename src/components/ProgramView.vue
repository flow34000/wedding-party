  ...
  <div class="section" id="program">
    ...
    <div class="flex flex-column section-content gap-3">
      ...
      <div class="flex relative mt-3 mb-3">
        ...
        <img src="../assets/programme.png" class="w-full" />
      </div>
      <p>
        Pour plus d'informations pratiques sur le domaine des Côteaux d'Or, les hébergements et les baby-sitters,
        <a class="underline" href="#location">voir les infos pratiques </a>.
      </p>
    </div>
  </div>
</template>
