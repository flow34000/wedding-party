<template>
  <div id="story" class="section">
    ...
    <div class="flex flex-column section-content text-justify">
      <p>Hello, tu es curieux de savoir comment Floriane (alias Floflo) a pu rencontrer Florent (alias Flo)? Alors on se dévoile rien que pour vous!</p>
      <p>25 Mai 2012 </p>
        <p>Pour Floflo, l'année à Cambridge se termine et elle est appelée à aller passer un entretien à l'école de sage-femme de Nîmes. 
        L'occasion parfaite pour rejoindre Aurélie et ses cousins déjà sur place pour faire la féria nîmoise!</p>
        <p> Quelques verres de sangria et de Pastis aidant, Floflo tomba sous le charme fou de ce beau brun, bien fêtard, cousin d'Aurélie. </p>
      <p>21 Juin 2012</p>
